...
class _EditDonationScreenState extends State<EditDonationScreen> {
  ...
  void initState() {
    super.initState();
    _nameController = TextEditingController(text: widget.donation.productName);
    ...
    _latitude = widget.donation.latitude;
    _longitude = widget.donation.longitude;
  }
  ...
  Future<void> _submitDonation() async {
    ...
    await AppErrorHandler.performSafeAction(
      context,
      featureName: 'EditDonationScreen.submitDonation',
      ...
      action: () async {
        ...
        if (_imageBytes != null) {
          imageUrl = await _donationService.uploadImageFromBytes(_imageBytes!);
        }

        // 2. Create updated Donation object
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Edit Donasi', style: TextStyle(fontWeight: FontWeight.w600)),
          ...
          ? Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('Menyimpan perubahan...', style: AppTheme.bodyMedium),
                ],
              ),
            )
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Perbarui informasi barang donasi Anda',
